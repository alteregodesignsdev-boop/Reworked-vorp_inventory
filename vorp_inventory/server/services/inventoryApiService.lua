...
UsersInventories     = UsersInventories or { default = {} }
UsersInventories.default = UsersInventories.default or {}
...
function InventoryAPI.canCarryAmountItem(player, amount, cb)
	...
	local function cancarryammount()
		local totalAmount = InventoryAPI.getUserTotalCountItems(identifier, character.charIdentifier)
		local totalAmountWeapons = InventoryAPI.getUserTotalCountWeapons(identifier, character.charIdentifier, true)
		if character.invCapacity == -1 then
			return true
		end
		return totalAmount + totalAmountWeapons <= character.invCapacity
	end
